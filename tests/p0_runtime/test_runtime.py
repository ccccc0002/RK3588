...
class P0RuntimeTests(unittest.TestCase):
    ...
    def test_list_audit_records_before_id_cursor(self) -> None:
        ...
        self.assertAlmostEqual(0.0, float(page["window_time_missing_at_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_invalid_at_ratio"]), places=6)
        ...
        self.assertAlmostEqual(0.0, float(page["window_time_gap_range_seconds"]), places=6)
        self.assertEqual(0, int(page["window_time_gap_count"]))
        self.assertEqual(0, int(page["window_time_gap_zero_count"]))
        self.assertEqual(0, int(page["window_time_gap_nonzero_count"]))
        self.assertAlmostEqual(0.0, float(page["window_time_gap_zero_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_nonzero_ratio"]), places=6)
        ...
        self.assertAlmostEqual(0.0, float(page["window_time_gap_p75_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_p25_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_iqr_seconds"]), places=6)
        ...
        self.assertAlmostEqual(0.0, float(page["window_time_gap_stddev_seconds"]), places=6)
        ...
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_lower_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_upper_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_fence_span_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_fence_midpoint_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_effective_lower_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_effective_span_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_effective_midpoint_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_effective_coverage_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_lower_truncation_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_lower_truncation_ratio"]), places=6)
        self.assertFalse(bool(page["window_time_gap_outlier_lower_clipped"]))
        self.assertTrue(bool(page["window_time_gap_outlier_lower_unclipped"]))
        self.assertEqual("unclipped", page["window_time_gap_outlier_lower_clip_state"])
        self.assertEqual(0, int(page["window_time_gap_outlier_lower_clip_state_code"]))
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_lower_clipped_ratio"]), places=6)
        self.assertAlmostEqual(1.0, float(page["window_time_gap_outlier_lower_unclipped_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_ratio"]), places=6)
        self.assertEqual(0, int(page["window_time_gap_inlier_count"]))
        self.assertAlmostEqual(0.0, float(page["window_time_gap_inlier_ratio"]), places=6)
        self.assertEqual(0, int(page["window_time_gap_inlier_minus_outlier_count"]))
        self.assertEqual(0, int(page["window_time_gap_outlier_minus_inlier_count"]))
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_inlier_count_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_inlier_outlier_count_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_inlier_ratio_delta"]), places=6)
        self.assertEqual(0, int(page["window_time_gap_outlier_inlier_ratio_delta_basis_points"]))
        self.assertEqual(0, int(page["window_time_gap_outlier_inlier_ratio_delta_basis_points_abs"]))
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_inlier_ratio_delta_per_mille"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_inlier_ratio_delta_percentage_points"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_inlier_ratio_delta_percentage_points_abs"]), places=6)
        self.assertAlmostEqual(0.0, float(page["window_time_gap_outlier_inlier_ratio_delta_abs"]), places=6)
        self.assertEqual(0, int(page["window_time_gap_outlier_inlier_ratio_delta_sign"]))
        self.assertFalse(bool(page["window_time_gap_outlier_inlier_ratio_delta_positive"]))
        self.assertTrue(bool(page["window_time_gap_outlier_inlier_ratio_delta_nonpositive"]))
        self.assertFalse(bool(page["window_time_gap_outlier_inlier_ratio_delta_negative"]))
        self.assertTrue(bool(page["window_time_gap_outlier_inlier_ratio_delta_nonnegative"]))
        self.assertTrue(bool(page["window_time_gap_outlier_inlier_ratio_delta_zero"]))
        self.assertFalse(bool(page["window_time_gap_outlier_inlier_ratio_delta_nonzero"]))
        self.assertEqual("zero", page["window_time_gap_outlier_inlier_ratio_delta_state"])
        self.assertEqual("balanced", page["window_time_gap_outlier_inlier_ratio_delta_direction"])
        self.assertEqual(0, int(page["window_time_gap_outlier_inlier_ratio_delta_direction_code"]))
        ...
        if page_with_cursor["items"]:
            ...
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_missing_at_ratio"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_invalid_at_ratio"]), places=6)
            ...
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_range_seconds"]), places=6)
            self.assertEqual(0, int(page_with_cursor["window_time_gap_count"]))
            self.assertEqual(0, int(page_with_cursor["window_time_gap_zero_count"]))
            self.assertEqual(0, int(page_with_cursor["window_time_gap_nonzero_count"]))
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_zero_ratio"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_nonzero_ratio"]), places=6)
            ...
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_p75_seconds"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_p25_seconds"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_iqr_seconds"]), places=6)
            ...
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_stddev_seconds"]), places=6)
            ...
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_lower_seconds"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_upper_seconds"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_fence_span_seconds"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_fence_midpoint_seconds"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_effective_lower_seconds"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_effective_span_seconds"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_effective_midpoint_seconds"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_effective_coverage_ratio"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_lower_truncation_seconds"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_lower_truncation_ratio"]), places=6)
            self.assertFalse(bool(page_with_cursor["window_time_gap_outlier_lower_clipped"]))
            self.assertTrue(bool(page_with_cursor["window_time_gap_outlier_lower_unclipped"]))
            self.assertEqual("unclipped", page_with_cursor["window_time_gap_outlier_lower_clip_state"])
            self.assertEqual(0, int(page_with_cursor["window_time_gap_outlier_lower_clip_state_code"]))
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_lower_clipped_ratio"]), places=6)
            self.assertAlmostEqual(1.0, float(page_with_cursor["window_time_gap_outlier_lower_unclipped_ratio"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_ratio"]), places=6)
            self.assertEqual(0, int(page_with_cursor["window_time_gap_inlier_count"]))
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_inlier_ratio"]), places=6)
            self.assertEqual(0, int(page_with_cursor["window_time_gap_inlier_minus_outlier_count"]))
            self.assertEqual(0, int(page_with_cursor["window_time_gap_outlier_minus_inlier_count"]))
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_inlier_count_ratio"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_inlier_outlier_count_ratio"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta"]), places=6)
            self.assertEqual(0, int(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_basis_points"]))
            self.assertEqual(0, int(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_basis_points_abs"]))
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_per_mille"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_percentage_points"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_percentage_points_abs"]), places=6)
            self.assertAlmostEqual(0.0, float(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_abs"]), places=6)
            self.assertEqual(0, int(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_sign"]))
            self.assertFalse(bool(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_positive"]))
            self.assertTrue(bool(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_nonpositive"]))
            self.assertFalse(bool(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_negative"]))
            self.assertTrue(bool(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_nonnegative"]))
            self.assertTrue(bool(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_zero"]))
            self.assertFalse(bool(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_nonzero"]))
            self.assertEqual("zero", page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_state"])
            self.assertEqual("balanced", page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_direction"])
            self.assertEqual(0, int(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_direction_code"]))
        else:
            ...
            self.assertIsNone(page_with_cursor["window_time_missing_at_ratio"])
            self.assertIsNone(page_with_cursor["window_time_invalid_at_ratio"])
            ...
            self.assertIsNone(page_with_cursor["window_time_gap_range_seconds"])
            self.assertIsNone(page_with_cursor["window_time_gap_count"])
            self.assertIsNone(page_with_cursor["window_time_gap_zero_count"])
            self.assertIsNone(page_with_cursor["window_time_gap_nonzero_count"])
            self.assertIsNone(page_with_cursor["window_time_gap_zero_ratio"])
            self.assertIsNone(page_with_cursor["window_time_gap_nonzero_ratio"])
            ...
            self.assertIsNone(page_with_cursor["window_time_gap_p75_seconds"])
            self.assertIsNone(page_with_cursor["window_time_gap_p25_seconds"])
            self.assertIsNone(page_with_cursor["window_time_gap_iqr_seconds"])
            ...
            self.assertIsNone(page_with_cursor["window_time_gap_stddev_seconds"])
            ...
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_lower_seconds"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_upper_seconds"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_fence_span_seconds"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_fence_midpoint_seconds"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_effective_lower_seconds"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_effective_span_seconds"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_effective_midpoint_seconds"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_effective_coverage_ratio"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_lower_truncation_seconds"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_lower_truncation_ratio"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_lower_clipped"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_lower_unclipped"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_lower_clip_state"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_lower_clip_state_code"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_lower_clipped_ratio"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_lower_unclipped_ratio"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_ratio"])
            self.assertIsNone(page_with_cursor["window_time_gap_inlier_count"])
            self.assertIsNone(page_with_cursor["window_time_gap_inlier_ratio"])
            self.assertIsNone(page_with_cursor["window_time_gap_inlier_minus_outlier_count"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_minus_inlier_count"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_count_ratio"])
            self.assertIsNone(page_with_cursor["window_time_gap_inlier_outlier_count_ratio"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_basis_points"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_basis_points_abs"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_per_mille"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_percentage_points"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_percentage_points_abs"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_abs"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_sign"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_positive"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_nonpositive"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_negative"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_nonnegative"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_zero"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_nonzero"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_state"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_direction"])
            self.assertIsNone(page_with_cursor["window_time_gap_outlier_inlier_ratio_delta_direction_code"])
        ...
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_missing_at_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_invalid_at_ratio"]), places=6)
        ...
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_range_seconds"]), places=6)
        self.assertEqual(0, int(page_with_total["window_time_gap_count"]))
        self.assertEqual(0, int(page_with_total["window_time_gap_zero_count"]))
        self.assertEqual(0, int(page_with_total["window_time_gap_nonzero_count"]))
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_zero_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_nonzero_ratio"]), places=6)
        ...
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_p75_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_p25_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_iqr_seconds"]), places=6)
        ...
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_stddev_seconds"]), places=6)
        ...
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_lower_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_upper_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_fence_span_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_fence_midpoint_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_effective_lower_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_effective_span_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_effective_midpoint_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_effective_coverage_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_lower_truncation_seconds"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_lower_truncation_ratio"]), places=6)
        self.assertFalse(bool(page_with_total["window_time_gap_outlier_lower_clipped"]))
        self.assertTrue(bool(page_with_total["window_time_gap_outlier_lower_unclipped"]))
        self.assertEqual("unclipped", page_with_total["window_time_gap_outlier_lower_clip_state"])
        self.assertEqual(0, int(page_with_total["window_time_gap_outlier_lower_clip_state_code"]))
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_lower_clipped_ratio"]), places=6)
        self.assertAlmostEqual(1.0, float(page_with_total["window_time_gap_outlier_lower_unclipped_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_ratio"]), places=6)
        self.assertEqual(0, int(page_with_total["window_time_gap_inlier_count"]))
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_inlier_ratio"]), places=6)
        self.assertEqual(0, int(page_with_total["window_time_gap_inlier_minus_outlier_count"]))
        self.assertEqual(0, int(page_with_total["window_time_gap_outlier_minus_inlier_count"]))
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_inlier_count_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_inlier_outlier_count_ratio"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_inlier_ratio_delta"]), places=6)
        self.assertEqual(0, int(page_with_total["window_time_gap_outlier_inlier_ratio_delta_basis_points"]))
        self.assertEqual(0, int(page_with_total["window_time_gap_outlier_inlier_ratio_delta_basis_points_abs"]))
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_inlier_ratio_delta_per_mille"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_inlier_ratio_delta_percentage_points"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_inlier_ratio_delta_percentage_points_abs"]), places=6)
        self.assertAlmostEqual(0.0, float(page_with_total["window_time_gap_outlier_inlier_ratio_delta_abs"]), places=6)
        self.assertEqual(0, int(page_with_total["window_time_gap_outlier_inlier_ratio_delta_sign"]))
        self.assertFalse(bool(page_with_total["window_time_gap_outlier_inlier_ratio_delta_positive"]))
        self.assertTrue(bool(page_with_total["window_time_gap_outlier_inlier_ratio_delta_nonpositive"]))
        self.assertFalse(bool(page_with_total["window_time_gap_outlier_inlier_ratio_delta_negative"]))
        self.assertTrue(bool(page_with_total["window_time_gap_outlier_inlier_ratio_delta_nonnegative"]))
        self.assertTrue(bool(page_with_total["window_time_gap_outlier_inlier_ratio_delta_zero"]))
        self.assertFalse(bool(page_with_total["window_time_gap_outlier_inlier_ratio_delta_nonzero"]))
        self.assertEqual("zero", page_with_total["window_time_gap_outlier_inlier_ratio_delta_state"])
        self.assertEqual("balanced", page_with_total["window_time_gap_outlier_inlier_ratio_delta_direction"])
        self.assertEqual(0, int(page_with_total["window_time_gap_outlier_inlier_ratio_delta_direction_code"]))
